...
# println(get_artist_albums(spotifyDetails, "59sBwR0jPSTrbMtuTkRPN5"))
# println(get_artist_top_tracks(spotifyDetails, "59sBwR0jPSTrbMtuTkRPN5"))
println(get_artist_related_artists(spotifyDetails, "59sBwR0jPSTrbMtuTkRPN5"))